...
> This implementation is quite old and doesn't follow the [specifications](https://github.com/AntoineBlondon/muni2wasm/the_muni_specifications-V1.pdf) perfectly, I am currently rewriting the compiler to be complient with Version 1.
